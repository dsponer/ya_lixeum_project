...
# Form implementation generated from reading ui file 'window_with_buttons_bottom.ui'
#
...
class Ui_MainWindow(QMainWindow, object):
    def setupUi(self, MainWindow):
        ...
        self.buttonBox.setGeometry(QtCore.QRect(840, 650, 161, 32))
    ...
    def save(self):
        ...
        self.file_path, ok_pressed = QInputDialog.getText(self, "Enter the path to the file directory",
            "What the path?                                                                              ")
        if self.file_path != '':
            tree.write(self.file_path + '\\' + 'dialog_with_buttons_bottom.ui')
        else:
            tree.write(self.file_path + 'dialog_with_buttons_bottom.ui')
