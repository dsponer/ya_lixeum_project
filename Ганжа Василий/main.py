import sys
import os
from PyQt5.QtWidgets import QApplication, QMainWindow, QInputDialog, QLabel, QPushButton, QWidget
...
class Main_Window(QMainWindow, Ui_MainWindow):
    ...
    def set_image_di(self):
        self.statusbar.removeWidget(self.labell)
        self.statusbar.setStyleSheet('background: pink;')
        self.img_path, self.py_path, self.ui_path = self.pixdict[self.sender()]
